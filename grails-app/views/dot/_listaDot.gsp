<!--<g:each   in ="${dots}">
    ...
    <div class="hoverzoom col-xs-12 divevento" >
        ...
        <g:if test="${it.imagem}">
            <img style="border-radius: 20px" src="/dot/imagem/${it.id}"/>
        </g:if><g:else>
...
<div    class="col-xs-12 divevento  TEXT-CENTER tamanho" style="background: orange" >

    <h1>div3</h1>

</div>
<div    class="  col-xs-12  divevento TEXT-CENTER tamanho" style="background: blueviolet" >
    <h1>div2</h1>
</div>
<div    class="col-xs-12 divevento  TEXT-CENTER tamanho" style="background: orange" >
